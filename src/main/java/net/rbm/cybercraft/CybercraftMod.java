...
@Mod("cybercraft")
public class CybercraftMod {
	public static final Logger LOGGER = LogManager.getLogger(CybercraftMod.class);
	public static final String MODID = "cybercraft";

	public CybercraftMod(IEventBus modEventBus) {
